...
resources/skills/*/bkl.skill.json
resources/skills/*/schemas/
resources/tools/*
...
```bash
bkl memory add --target memory "当前项目默认使用 resources/skills 作为技能目录"
...
```text
resources/skills/content-video-workflow/AGENTS.md
...
```text
resources/skills/<skill_id>/SKILL.md
```

同时增加可选知识目录：

```text
resources/skills/<skill_id>/knowledge/
  style-guide.md
  examples.md
  platform-rules.md
  product-facts.md
...
```json
{
  ...
  "source_path": "resources/skills/content-video-workflow/knowledge/style-guide.md",
...
[source: resources/skills/.../knowledge/style-guide.md > 小红书口播 > 开头结构]
...
...
```text
本次命中知识：
1. resources/skills/content-video-workflow/knowledge/xhs-style.md > 开头结构
2. resources/skills/content-video-workflow/knowledge/openspec.md > 核心价值
...
- [ ] 支持 `resources/skills/*/knowledge/*.md`
- [ ] Markdown chunker
...
2. Skill knowledge:
   resources/skills/<skill_id>/knowledge/*.md
